document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      ...
      errorDiv.style.cssText = 'color: red; font-size: 0.875rem; margin-top: 5px;';
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "PickNgo uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'd9a49b3d-2742-48fc-829b-eed2eb3aa4b4',
                    name: data.name || '',
                    email: data.email || '',
